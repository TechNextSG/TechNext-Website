...
`;
  ...
  if (!document.getElementById('tnBot')) {
    ...
    _bs.textContent = `
#tnBotBtn{position:fixed;bottom:100px;right:28px;z-index:1900;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#6c93dc,#425eae);color:#fff;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(49,103,202,.45);border:none;cursor:pointer;transition:transform .2s,box-shadow .2s}
...
.bot-header{background:linear-gradient(135deg,#425eae,#6c93dc);padding:14px 16px;display:flex;align-items:center;gap:10px;flex-shrink:0}
...
.bot-msg-avatar{width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#6c93dc,#425eae);display:flex;align-items:center;justify-content:center;font-size:.6rem;font-weight: 700;color:#fff;flex-shrink:0}
...
.bot-bubble.user{background:linear-gradient(135deg,#6c93dc,#425eae);color:#fff;border-radius:16px 16px 4px 16px;box-shadow:0 2px 8px rgba(49,103,202,.3)}
